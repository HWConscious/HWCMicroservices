...
```
    cd "HWC_GetDisplayEndpointNotifications"
    dotnet restore
```

Execute unit tests
```
    cd "HWC_GetDisplayEndpointNotifications/test/HWC_GetDisplayEndpointNotifications.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "HWC_GetDisplayEndpointNotifications/src/HWC_GetDisplayEndpointNotifications"
