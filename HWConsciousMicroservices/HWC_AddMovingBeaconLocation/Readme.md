...
```
    cd "HWC_AddMovingBeaconLocation"
    dotnet restore
```

Execute unit tests
```
    cd "HWC_AddMovingBeaconLocation/test/HWC_AddMovingBeaconLocation.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "HWC_AddMovingBeaconLocation/src/HWC_AddMovingBeaconLocation"
