...
```
    cd "HWC_SeedDemoContentIntoDB"
    dotnet restore
```

Execute unit tests
```
    cd "HWC_SeedDemoContentIntoDB/test/HWC_SeedDemoContentIntoDB.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "HWC_SeedDemoContentIntoDB/src/HWC_SeedDemoContentIntoDB"
