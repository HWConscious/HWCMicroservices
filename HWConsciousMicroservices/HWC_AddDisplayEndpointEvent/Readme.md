...
```
    cd "HWC_AddDisplayEndpointEvent"
    dotnet restore
```

Execute unit tests
```
    cd "HWC_AddDisplayEndpointEvent/test/HWC_AddDisplayEndpointEvent.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "HWC_AddDisplayEndpointEvent/src/HWC_AddDisplayEndpointEvent"
